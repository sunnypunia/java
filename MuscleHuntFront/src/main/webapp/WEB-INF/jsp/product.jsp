			  	...
			  	<div class="panel-body">
                    ...
                    <fieldset>
			    	  	<div class="form-group">
			    		    <input class="form-control" placeholder="Product_id" name="product_id" type="text">
			    		</div>
			    		<div class="form-group">
			    		    <input class="form-control" placeholder="Name" name="product_name" type="text">
			    		</div>
			    		<div class="form-group">
			    		    <input class="form-control" placeholder="Brand" name="product_brand" type="text">
			    		</div>
			    		<div class="form-group">
			    		    <input class="form-control" placeholder="Description" name="product_description" type="text">
			    		</div>
			 
			    		<input class="btn btn-lg btn-danger btn-block" type="Add" value="update">
			    	</fieldset>
			      	</form>
			    </div>
			</div>
